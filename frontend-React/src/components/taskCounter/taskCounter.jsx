export function TaskCounter({type = "todo", count = 0} = props) {
  return (
    <div className="flex flex-col justify-center items-center">
      <div className={`p-6 border-solid
        ...
        <div className="min-w-10 min-h-10 text-white text-3xl text-center flex justify-center leading-10">{count}</div>
      </div>
      <div>
